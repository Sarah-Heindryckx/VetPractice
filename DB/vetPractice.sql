...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 10 jul 2015 om 12:50
-- Serverversie: 5.6.24
-- PHP-versie: 5.6.8
...
--
-- Gegevens worden geëxporteerd voor tabel `consultatie`
--

INSERT INTO `consultatie` (`id`, `gewicht`, `dierId`, `datum`, `notitie`, `dierenartsId`, `vaccinatieId`) VALUES
(1, '0', 6, '2015-07-10 12:48:39', 'flaffie controle ok, nieuwe vaccinatie', 1, 1);
...
--
-- Gegevens worden geëxporteerd voor tabel `dierenarts`
--

INSERT INTO `dierenarts` (`id`, `naam`, `voornaam`, `email`, `straat`, `wachtwoord`, `huisnr`, `postcode`, `woonplaats`, `tel`) VALUES
(1, 'Dr. Pol', '', 'drpol@hotmail.com', 'Vlamingstraat', 'test123', '12', '', 'Wevelgem', '');
...
--
-- Gegevens worden geëxporteerd voor tabel `vaccinatie`
--

INSERT INTO `vaccinatie` (`id`, `naam`, `datum`, `memo`) VALUES
(1, 'hepatitis', '2015-07-08', '1e vaccinatie hepatitis in 2012');
